...
urlpatterns = [
    ...
    path('<int:timesheet_pk>/add-entry/', views.add_daily_entry, name='add_daily_entry'),
    path('sdashboard/', views.supervisor_dashboard, name='supervisor_dashboard'),
    path('financial_manager_dashboard/', views.financial_manager_dashboard, name='financial_manager_dashboard'),
    path('approve/<int:timesheet_id>/', views.supervisor_approve_timesheet, name='supervisor_approve_timesheet'),
    path('financial-manager/approve/<int:timesheet_id>/', views.financial_manager_approve_timesheet, name='financial_manager_approve_timesheet'),  # Financial manager approval
]
